...
function SystemUpdate() {
  ...
  const [previousSystem, setPreviousSystem] = React.useState<System | null>(null);
  ...
  const handleUpdateSystem = async () => {
    const { description, acronym, email, url, status, justification } = newSystem;
    ...
    if (previousSystem.description === newSystem.description &&
      ...
      <div className="page-content h-100 w-100">
        <Container fluid>
          ...
          <MainContent>
            <Card>
              <CardHeader>
                <h3 style={{ color: "green", fontWeight: "bold" }}>Dados do Sistema</h3>
              </CardHeader>
              <CardBody>
                <Col
                  style={{
                  ...
                  <Col className='mb-3 d-flex justify-content-center'>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewSystem({ ...newSystem, email: e.target.value })}
                    />
                  </Col>
                  <Col className='mb-3 d-flex justify-content-center'>
                    <Label
            ...
            <Card>
              <CardHeader>
                <h3 style={{ color: "green", fontWeight: "bold" }}>Controle do Sistema</h3>
              </CardHeader>
              ...
              <CardBody>
                <Col
                  ...
                  <Col className='mb-3 d-flex justify-content-center'>
                    <Label
                      className='w-50 ms-3 fs-4 fw-bold border-bottom'>
                      Nova justificativa de alteração <span className='text-danger'>*</span>
                      <CharsCounter text={newSystem.justification} limit={500} />
                    </Label>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewSystem({ ...newSystem, justification: e.target.value })}
                    />
                  </Col>
                </Col>
              </CardBody>
